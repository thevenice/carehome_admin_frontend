...
const CareHomeForm = () => {
  ...
  const [formData, setFormData] = useState<FormData>({
    name: '',
    location: [0, 0], // Change to numbers
    registration_date: '',
    owner_id: '',
    settings: {
      background_color: '',
  ...
  const handleChange = (
    ...
    if (name.startsWith('settings.')) {
      const settingName = name.split('.')[1] // Extract the setting name
      setFormData((prevFormData) => ({
        ...prevFormData,
        settings: {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Failed to add care home')
      }
  ...
  return (
    <div className="grid">
      ...
      ${errors.location && errors.location[0] ? 'border-red-500' : ''}`}
                  value={
                    formData.location[0] === null ? '' : formData.location[0]
                  }
                  onChange={handleChange}
                />
      ...
      ${errors.location && errors.location[1] ? 'border-red-500' : ''}`}
                  value={
                    formData.location[1] === null ? '' : formData.location[1]
                  }
                  onChange={handleChange}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`
                    w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary
                    ${errors.settings && errors.settings.background_color ? 'border-red-500' : ''}`}
                  value={formData.settings.background_color}
                  onChange={handleSettingsChange}
                />
                {errors.settings && errors.settings.background_color && (
                  <p className="text-red-500 text-sm mt-1">
              ...
              <div>
                ...
                <input
                  ...
                  className={`
                    w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary
                    ${errors.settings && errors.settings.text_color ? 'border-red-500' : ''}`}
                  value={formData.settings.text_color}
                  onChange={handleSettingsChange}
                />
                {errors.settings && errors.settings.text_color && (
                  <p className="text-red-500 text-sm mt-1">
              ...
              <div>
                ...
                <input
                  ...
                  className={`
                    w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary
                    ${errors.settings && errors.settings.font ? 'border-red-500' : ''}`}
                  value={formData.settings.font}
                  onChange={handleSettingsChange}
                />
                {errors.settings && errors.settings.font && (
                  <p className="text-red-500 text-sm mt-1">
