    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (data.role !== 'ADMINISTRATOR') {
          setErrorMessage('Only administrators are allowed to log in.')
        } else {
          // Store user data
          setAuthData({
            token: data.token,
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-5">
                  <button
                    type="submit"
                    className="w-full rounded-lg bg-primary py-4 px-6 font-medium text-white outline-none focus:shadow-none"
                    disabled={isLoading}
                  >
