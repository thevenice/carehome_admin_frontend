...
const CreateUpdateResidentProfile: React.FC = () => {
  ...
  const handleRemoveArrayField = (
    ...
    setFormData((prevState) => ({
      ...prevState,
      [fieldName]: (prevState[fieldName] as string[]).filter(
        (_, i) => i !== index,
      ),
    }))
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(
        userId
          ? 'Resident info updated successfully'
          : 'Resident created successfully',
      )
    } catch (error) {
      console.error('Error:', error)
      alert(
        userId ? 'Failed to update resident info' : 'Failed to create resident',
      )
    }
  }
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {formData.secondaryDiagnoses.map((diagnosis, index) => (
                    <div key={index} className="flex items-center space-x-4">
                      <input
                        ...
                        value={diagnosis}
                        onChange={(e) =>
                          handleArrayChange(e, 'secondaryDiagnoses', index)
                        }
                        className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                      />
                      <button
                        ...
                        onClick={() =>
                          handleRemoveArrayField('secondaryDiagnoses', index)
                        }
                      >
                        Remove
                      </button>
                  ...
                  {formData.allergies.map((allergy, index) => (
                    <div key={index} className="flex items-center space-x-4">
                      <input
                        ...
                        value={allergy}
                        onChange={(e) =>
                          handleArrayChange(e, 'allergies', index)
                        }
                        className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                      />
                      <button
                        ...
                        className="text-red-600 hover:text-red-700 focus:outline-none"
                        onClick={() =>
                          handleRemoveArrayField('allergies', index)
                        }
                      >
                        Remove
                      </button>
                  ...
                  {formData.dietaryRestrictions.map((restriction, index) => (
                    <div key={index} className="flex items-center space-x-4">
                      <input
                        ...
                        value={restriction}
                        onChange={(e) =>
                          handleArrayChange(e, 'dietaryRestrictions', index)
                        }
                        className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                      />
                      <button
                        ...
                        className="text-red-600 hover:text-red-700 focus:outline-none"
                        onClick={() =>
                          handleRemoveArrayField('dietaryRestrictions', index)
                        }
                      >
                        Remove
                      </button>
                ...
                <div className="mb-4">
                  ...
                  <select
                    id="dnrStatus"
                    name="dnrStatus"
                    value={formData.dnrStatus ? 'true' : 'false'}
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...prev,
                        dnrStatus: e.target.value === 'true',
                      }))
                    }
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  >
                  ...
                  {formData.medications.map((medication: any, index) => (
                    <div key={index} className="mb-2">
                      ...
                      <button
                        ...
                        className="text-red-600 hover:text-red-700 focus:outline-none"
                        onClick={() =>
                          handleRemoveArrayField('medications', index)
                        }
                      >
                        Remove Medication
                      </button>
                  ...
                  {formData.emergencyContacts.map((contact: any, index) => (
                    <div key={index} className="mb-2">
                      ...
                      <button
                        ...
                        className="text-red-600 hover:text-red-700 focus:outline-none"
                        onClick={() =>
                          handleRemoveArrayField('emergencyContacts', index)
                        }
                      >
                        Remove Contact
                      </button>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleNestedChange(e, 'primaryPhysician', 'name')
                    }
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary mb-2"
                  />
                  <input
                    ...
                    onChange={(e) =>
                      handleNestedChange(e, 'primaryPhysician', 'contactNumber')
                    }
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  />
                </div>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleNestedChange(e, 'insuranceInfo', 'provider')
                    }
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary mb-2"
                  />
                  <input
                    ...
                    onChange={(e) =>
                      handleNestedChange(e, 'insuranceInfo', 'policyNumber')
                    }
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  />
                </div>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleNestedChange(e, 'legalGuardian', 'name')
                    }
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary mb-2"
                  />
                  <input
                    ...
                    onChange={(e) =>
                      handleNestedChange(e, 'legalGuardian', 'relationship')
                    }
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary mb-2"
                  />
                  <input
                    ...
                    onChange={(e) =>
                      handleNestedChange(e, 'legalGuardian', 'contactNumber')
                    }
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary mb-2"
                  />
                  <input
                    ...
                    onChange={(e) =>
                      handleNestedChange(e, 'legalGuardian', 'email')
                    }
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  />
                </div>
